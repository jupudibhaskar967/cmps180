    ...
    public static void main(String[] args) {
    	...
    	try {
            ...
            connection = DriverManager.getConnection(
                                                     "jdbc:postgresql://cmps180-db.lt.ucsc.edu/njupudi",
                                                     "njupudi",
                                                     "compound01import");
            ...
            /*part-1*/
	     /*print all the product names with total sales price > 300*/
	     List<String> result = new ArrayList<String>();
	     result = app.getProductNamesWithTotalPriceLargerThan(300);
             System.out.println(result);
             
             /*part-2*/
             /*part-2a*/
             /*already exisiting product*/
